...
\begin{figure}[h!]
    ...
    \caption{Динамика общего количества запросов <<искусственный интеллект>> и их процентного отношения относительно всех запросов в поисковой системе Яндекса за период с января 2018 г. по июль 2024 г. по всему миру. График построен на основе значений из таблицы}\label{fig:wordstat_dynamics}
\end{figure}
